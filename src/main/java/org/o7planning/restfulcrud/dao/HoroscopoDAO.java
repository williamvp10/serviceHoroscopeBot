...
public class HoroscopoDAO {
    ...
    private static void initEmps() {
        ...
        horoscopo.setHoroscope("Siempre es importante invertir dinero en una propiedad, si tienes la posibilidad de hacerlo este mismo día, hazlo sin pensarlo dos veces, es algo que se mantendrá en el tiempo y que puedes echar mano cuando tengas un problema económico."
